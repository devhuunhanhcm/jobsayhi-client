                                        ...
                                        <div className="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                            ...
                                            <div className="card-block-info">
                                                ...
                                                <p className="mt-10 color-text-paragraph font-sm">
                                                    ...
                                                    healthcare company by creating high-quality healthcare products in
                                                    iconic, sustainable packaging.
                                                </p>
                                                <div className="card-2-bottom mt-20">
                                                    <div className="row">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="card-grid-3 hover-up wow animate__animated animate__fadeIn">
                                            ...
                                            <div className="card-block-info">
                                                ...
                                                <p className="mt-10 color-text-paragraph font-sm">
                                                    Learn how to respond if an interviewer asks you why you dont have a
                                                    degree, and read example answers that can help you craft
                                                </p>
                                                <div className="card-2-bottom mt-20">
                                                    <div className="row">
                                                        <div className="col-lg-6 col-6">
